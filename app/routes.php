...
return function (App $app) {
    ...
    $app->group('', function (Group $group) {
        $group->group('/cohorts', function (Group $group) {
        ...
        $group->group('/drawings', function (Group $group) {
        ...
        $group->group('/unavailabilities', function (Group $group) {
        ...
        $group->group('/vacations', function (Group $group) {
